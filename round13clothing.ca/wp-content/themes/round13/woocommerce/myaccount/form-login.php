      ...
      <div class="u-columns col2-set" id="customer_login">
          ...
          <div class="col-md-6">
                ...
                <div class="row">
                    <form method="post" id="login_frm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form_row form_btn_section">
                                <div class="form_col col_left">
            <!--                         <p class="woocommerce-LostPassword lost_password">-->
                                ...
                                <div class="form_col col_right">
                                    <?php wp_nonce_field('woocommerce-login', 'woocommerce-login-nonce'); ?>
                                    <input type="submit" class="woocommerce-Button black_btn" name="login" value="<?php esc_attr_e('Login', 'woocommerce'); ?>" />
                  ...
                  <div class="register_form">
                      ...
                      <div class="row">
                          <form method="post" id="register_frm" >
                              ...
                              <div class="woocomerce-FormRow form-row form_btn_section">
                                  <div class="form_col col_right">
                                      <?php wp_nonce_field('woocommerce-register', 'woocommerce-register-nonce'); ?>
                                      <input type="submit" class="woocommerce-Button black_btn" name="register" value="<?php esc_attr_e('Register', 'woocommerce'); ?>" />
           <!--                      <input type="submit" class="woocommerce-Button button black_btn" name="register" value="<?php //esc_attr_e('Register', 'woocommerce');  ?>" />-->
                                  </div>
                              </div>
